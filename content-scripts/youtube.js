...
function addQuickAddButtons() {
  ...
  const videoElements = document.querySelectorAll('ytd-video-renderer, ytd-grid-video-renderer, ytd-playlist-video-renderer');
  ...
  videoElements.forEach(element => {
    ...
    const menuContainer = element.querySelector('#menu') || 
                         element.querySelector('ytd-menu-renderer');
    if (menuContainer) {
...
function getVideoId(element) {
  const link = element.querySelector('a#video-title') ||
               element.querySelector('a.yt-simple-endpoint');
...
function setupContextMenu() {
  document.addEventListener('contextmenu', (e) => {
    const videoElement = e.target.closest('ytd-video-renderer, ytd-grid-video-renderer, ytd-playlist-video-renderer');
